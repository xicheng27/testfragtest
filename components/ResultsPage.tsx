          ...
          <section className="grid gap-5 lg:grid-cols-[0.86fr_1.14fr] lg:items-stretch">
            <article className="relative overflow-hidden rounded-[2rem] border border-stone-200 bg-stone-950 p-5 text-white shadow-[0_24px_70px_rgba(28,25,23,0.18)] sm:p-8">
              ...
              <div className="relative">
                ...
                <h1 className="mt-3 text-[2.75rem] font-black leading-[0.95] tracking-[-0.06em] sm:text-6xl">
                  {personality.title}
                </h1>
                ...
                {topFragrance && (
                  <div className="mt-6 overflow-hidden rounded-[1.5rem] bg-white text-stone-950">
                    ...
                    <div className="border-t border-stone-100 p-4">
                      ...
                      <h2 className="mt-1 text-[2rem] font-black leading-tight tracking-[-0.04em]">{topFragrance.name}</h2>
