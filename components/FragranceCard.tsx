      ...
      {result && (
        <div className="flex items-center justify-between gap-4 border-b border-stone-100 bg-stone-50/70 px-4 py-3 sm:px-6">
          <div className="min-w-0">
            ...
            <p className="mt-0.5 truncate text-lg text-stone-500">
        ...
        <div className="min-w-0 p-5 sm:p-7">
          ...
          <dl className="mt-6 grid grid-cols-2 gap-x-5 gap-y-4 border-y border-stone-100 py-5 sm:grid-cols-3">
            <div className="col-span-2 sm:col-span-3">
              ...
              <dd className="mt-1.5 text-lg leading-relaxed text-stone-800">
                {fragrance.notes.slice(0, 5).join(' · ')}
              </dd>
            </div>
            <div>
              <dt className="text-[10px] font-semibold uppercase tracking-[0.16em] text-stone-400">Best for</dt>
              <dd className="mt-1 text-lg font-medium capitalize text-stone-800">
            ...
            <section className="mt-6 rounded-2xl bg-stone-950 p-4.5 text-white sm:p-5" aria-labelledby={`why-${fragrance.id}`}>
              ...
              <ul className="mt-3 space-y-2.5">
                {reasonItems.map(reason => (
                  <li key={reason} className="flex gap-2.5 text-lg leading-relaxed text-stone-300">
          ...
          <div className="mt-6 grid gap-2 sm:grid-cols-3">
            <button
              ...
              className={clsx(
                'flex min-h-12 items-center justify-center gap-2 rounded-xl px-4 text-lg font-medium transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-950',
                saved
            ...
            <button
              ...
              className="min-h-12 rounded-xl border border-stone-300 px-4 text-lg font-medium text-stone-700 transition-colors hover:border-stone-500 hover:text-stone-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-950"
            >
